...
//        console.log(tree_node);
    ...
    it("binary tree insert data to tree", function () {
        var binary_tree = BinaryTree.create_tree_from_array_for_test([23,45,16,37,3,99]);
        console.log("create binary tree from a array, the array is 23,45,16,37,3,99")
        console.log("insert 22 to binary tree, true function exec, inoder traversal tree is 3,16,22,23,37,45,99")

        binary_tree.insert_data_to_tree(22);
        var mid_node_data = [];
        inoder_traversal_tree(binary_tree.root,mid_node_data);
        console.log("insert 22 to binary tree, your function exec, inoder traversal tree is "+mid_node_data);
